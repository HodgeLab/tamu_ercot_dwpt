...
to_json(system, joinpath(main_dir, "test_outputs/tamu_DA_basePV_sys.json"), force=true)
...
OUT_DIR = "C:/Users/A.J. Sauter/OneDrive - UCB-O365/Active Research/ASPIRE/CoSimulation Project/Julia_Modeling/test_outputs/DA_sys"
...
sim = Simulation(
    name = string("june_2day-", tran_set),
    steps = 2,
    problems = problems,
...
cd("C:/Users/A.J. Sauter/OneDrive - UCB-O365/Active Research/ASPIRE/CoSimulation Project/Julia_Modeling/test_outputs/RT_sys")
build!(sim)
...
date_folder = "Nov14_21/"
sim_week = "_BaseTest_"
sim_startday = "_6-01"
simplegen = string("SimpleGenStack", sim_week, tran_set, sim_startday)
plot_dir = "C:/Users/A.J. Sauter/OneDrive - UCB-O365/Active Research/ASPIRE/CoSimulation Project/Julia_Modeling/test_outputs/results/"
